...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="/workspace/data1/crm_data/",
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help="List of specific subdirectories to process. If empty, all subdirectories will be processed.",
    )
    ...
    # Process each sample folder in sam_data
    sample_folders = os.listdir(args.samdir)

    # If specific folders are provided, filter the sample_folders list
    if args.folders:
        sample_folders = [folder for folder in sample_folders if folder in args.folders]
