from transformers import T5Tokenizer, T5EncoderModel, CLIPTextModel
...
class FrozenT5Embedder(AbstractEncoder):
    ...
    def __init__(
            ...
            version="/mnt/ssd/fyz/t5-v1_1-large",
            device="cuda", max_length=77, freeze=True
...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(
            ...
            version="/mnt/ssd/fyz/openai/clip-vit-large-patch14",
            device="cuda",
            max_length=77,
            freeze=True,
            layer="last",
...
class FrozenOpenCLIPEmbedder(AbstractEncoder, nn.Module):
    ...
    def __init__(
            ...
            version="/mnt/ssd/fyz/CLIP-ViT-H-14-laion2B-s32B-b79K/open_clip_pytorch_model.bin",
            device="cuda",
            max_length=77,
            freeze=True,
            layer="last",
...
class FrozenCLIPT5Encoder(AbstractEncoder):
    def __init__(
            ...
            clip_version="/mnt/ssd/fyz/openai/clip-vit-large-patch14",
            # t5_version="google/t5-v1_1-xl",
            t5_version="/mnt/ssd/fyz/t5-v1_1-large",
            device="cuda",
            clip_max_length=77,
            t5_max_length=77,
    ):
